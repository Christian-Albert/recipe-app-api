...
class RecipeImageUploadTests(TestCase):
    ...
    def test_filter_recipes_by_tags(self):
        ...
        recipe1 = sample_recipe(user=self.user, title='Beef Stew')
        recipe2 = sample_recipe(user=self.user, title='Vegan Bowl')
        recipe3 = sample_recipe(user=self.user, title='Veggie Burger')
    ...
    def test_filter_recipes_by_ingredients(self):
        ...
        ingredient2 = sample_ingredient(user=self.user, name='Fake Beef')
